...
TABULAR_MODELS = [
    ...
    
    {
        ...
        "param_grid": {
            "iterations": [20, 50, 1000],    ### parameters "1000" and "0.1" as in the reference paper
            "depth": [3, 5, 10], ## maximum tree depth is 16
            "learning_rate": [0.001, 0.01, 0.1]            #"l2_leaf_reg": [3, 10],
        },
    },

    {
        ...
        "param_grid": {
            "n_estimators": [20, 50, 1000],   ### 80
            #"num_leaves": [15, 31, 63],
            "max_depth": [3, 5, 10, 20, 50],   ## 8
            "learning_rate": [0.001, 0.01, 0.1]  ### 0.01, 0.1, 0.3
            #"subsample": [0.8, 1.0],
