...
TABULAR_MODELS = [
...

    {
        ...
        "param_grid": {
            "iterations": [20, 50],    ### parameters different from "1000", "3" and "0.1" in the reference paper
            "depth": [5, 10], ## maximum tree depth is 16
            "learning_rate": [0.001, 0.01]            #"l2_leaf_reg": [3, 10],
        },
    },
...

    {
        ...
        "param_grid": {
            ...
            #"min_samples_split": [2, 5, 10],
            #"min_samples_leaf": [1, 2, 5],
            #"criterion": ["mse", "friedman_mse", "mae", "poisson"],  # lascialo commentato se vuoi
        },
    },
...
for mod in modes:
    ...
    output_path = os.path.join(root, "results/" + "run_v5.2" + "/results_" + mod + ".xlsx")
